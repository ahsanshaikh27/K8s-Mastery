...
**Request**: A pod is submitted with 1Gi memory
**Workflow**:
...
| /var/log                  | Holds logs from Kubernetes components       |
...
* Controls user/group access to cluster resources
* Define **Roles**, **ClusterRoles**, **RoleBindings**, and **ClusterRoleBindings**

### 🧱 Namespaces

* Logical partitions of the cluster
* Isolate workloads, manage quotas, and permissions

### 📊 Resource Quotas & Limits

* Set maximum CPU, memory, and object counts per namespace
* Prevents resource hogging

### 📦 Helm

* Kubernetes package manager
* Simplifies deployment of applications using charts

### 🛠️ Operators

* Extend Kubernetes API using Custom Resources
